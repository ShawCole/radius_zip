...
const MapContainer = () => {
  ...
  const [mapboxToken] = useState(import.meta.env.VITE_MAPBOX_TOKEN || 'pk.eyJ1Ijoic2hhd2NvbGUiLCJhIjoiY21jcm95bzhnMHR4aDJqcTB5bm8zZTVhYSJ9.5t0L7sw1yXB8erVH-HlLbg');
